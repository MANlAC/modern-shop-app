        ...
        <div className="flex items-center justify-center py-20">
          <Card className="w-full max-w-sm border-border/40 bg-card text-center">
            <CardContent className="pt-8">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Admin access has already been configured for this store.
                Sign in as the admin user and use the admin panel.
              </p>
              <Button
                variant="outline"
                className="mt-6"
          ...
          <CardContent className="space-y-4">
            {!isAuthenticated && (
              <p className="rounded-lg border border-primary/20 bg-primary/5 p-3 text-xs text-primary">
                Please sign in first, then return to this page to set up
                admin access.
              </p>
            )}
            <div>
